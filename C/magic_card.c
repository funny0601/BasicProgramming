...
int my_card1(int(*ca1)[4]) {
	...
	while (1) {
		...
		printf(" ----------\n");
		printf("\n\n");
		printf("A카드에 생각한 숫자가 있다면 YES(1번),\n");
...
int my_card2(int(*ca2)[4]) {
	...
	while (1) {
		...
		printf(" ----------\n");
		printf("\n\n");
		printf("B카드에 생각한 숫자가 있다면 YES(1번),\n");
		printf("없다면 NO(0번)을 선택하여 주시기 바랍니다. :");
		scanf("%d", &b);
		printf("\n\n");
...
int my_card3(int(*ca3)[4]) {
	...
	while (1) {
		...
		printf(" ----------\n");
		printf("\n\n");
		printf("C카드에 생각한 숫자가 있다면 YES(1번),\n");
		printf("없다면 NO(0번)을 선택하여 주시기 바랍니다. :");
		scanf("%d", &c);
		printf("\n\n");
...
int my_card4(int(*ca4)[4]) {
	...
	while (1) {
		...
		printf(" ----------\n");
		printf("\n\n");
		printf("D카드에 생각한 숫자가 있다면 YES(1번),\n");
		printf("없다면 NO(0번)을 선택하여 주시기 바랍니다. :");
		scanf("%d", &d);
		printf("\n\n");
...
int my_card5(int(*ca5)[4]) {
	...
	while (1) {
		...
		printf(" ----------\n");
		printf("\n\n");
		printf("E카드에 생각한 숫자가 있다면 YES(1번),\n");
		printf("없다면 NO(0번)을 선택하여 주시기 바랍니다. :");
		scanf("%d", &e);
		printf("\n\n");
